...
description: "Use Claude to check your docs against a style guide. Index the HashiCorp style guide into Grounded Docs, install two skills, and catch every style violation."
---
