...
In this tutorial, you learn how to provide your AI with versioned documentation to fact-check your content. You use Grounded Docs to index two versions
...
<Steps>
  ...
  <Step title="Fact-check against React v18.3.1">
    ...
    Claude returns multiple findings with citations from the React 18.3.1 docs.
    
    The findings include one for the `forwardRef` pattern, confirming it is supported and accurately described in the tutorial:

    The `forwardRef` pattern is valid in React 18, so it passes:
...
<Steps>
  ...
  All six claims pass against React 19.2.
  </Step>
</Steps>

In this tutorial, you learned how to use Grounded Docs to index versioned documentation. You enhanced your AI's fact-checking capabilities with citation-backed findings.
Providing your AI with specific, up-to-date sources significantly improves the accuracy and reliability of its reviews. Your content stays aligned with the latest information.
